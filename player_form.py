...
class Player_app(customtkinter.CTkScrollableFrame):

    def __init__(self, master):
        super(Player_app, self).__init__(master,corner_radius=0,fg_color='transparent')
        ...
        self.canva = customtkinter.CTkCanvas(self,height=625, width=630,background='white')
        #canva.configure(bg='light blue')
        self.canva.grid(row=0, column=0, rowspan=28, columnspan= 4,sticky= 'nsew')
        self.img = customtkinter.CTkImage(Image.open('./images/playerbg.JPG'),size=(1500,1500))
    ...
    def create_widgets(self):
        self.lbl_title = customtkinter.CTkLabel(self, text="Player's Registration Form",
                               font=("", 20, 'bold'),bg_color='black',text_color='white')
        self.lbl_title.grid(row=0, column=0, columnspan=3,padx= (5,5),sticky=N)
        ...
        # Name
        self.lbl_name = customtkinter.CTkLabel(self, text='Name: ', font=("calibri", 19),bg_color='black',text_color='white')
        self.lbl_name.grid(row=1, column=0, sticky=W,padx= (5,5))
        pywinstyles.set_opacity(widget=4, color='black')
        ...
        # DOB
        self.lbl_dob = customtkinter.CTkLabel(self, text='D.O.B:', font=("calibri", 19),bg_color='black',text_color='white')
        ...
        # Email
        self.lbl_email = customtkinter.CTkLabel(self, text='Email:', font=("calibri", 19),bg_color='black',text_color='white')
        self.lbl_email.grid(row=5, column=0, sticky=W,padx= (5,5))
        #pywinstyles.set_opacity(self.lbl_email, color="black")
        self.ent_email = customtkinter.CTkEntry(self, width= 400,bg_color='black',placeholder_text='example26@gmail.com')
        self.ent_email.grid(row=6, column=0,columnspan=2, sticky=W,padx= (5,5))

        # Phone
        self.lbl_phone = customtkinter.CTkLabel(self, text='Phone:', font=("calibri", 19),bg_color='black',text_color='white')
        ...
        # Address
        self.lbl_address = customtkinter.CTkLabel(self, text='Address:', font=("calibri", 19),bg_color='black',text_color='white')
        ...
        # City
        self.lbl_city = customtkinter.CTkLabel(self, text='City:', font=("calibri", 19),bg_color='black',text_color='white')
        self.lbl_city.grid(row=11, column=0, sticky=W,padx= (5,5))
        #pywinstyles.set_opacity(self.lbl_city, color="black")
        self.lbl_region = customtkinter.CTkLabel(self, text='Region:', font=("calibri", 19),bg_color='black',text_color='white')
        ...
        # postal
        self.lbl_postal = customtkinter.CTkLabel(self, text='Postal/Zip code', font=("calibri", 19),bg_color='black',text_color='white')
        ...
        # country
        self.lbl_country = customtkinter.CTkLabel(self, text='Country', font=("calibri", 19),bg_color='black',text_color='white')
        self.lbl_country.grid(row=13, column=2, sticky=W,padx= (5,5))
        #pywinstyles.set_opacity(self.lbl_country, color="black")
        self.dwd_country = customtkinter.CTkComboBox(self, variable=self.country, width=230,values=get_country(),bg_color='black')
        ...
        # Gender
        self.lbl_gender = customtkinter.CTkLabel(self, text='Gender:', font=("calibri", 19),bg_color='black',text_color='white')
        self.lbl_gender.grid(row=15, column=0, sticky=W,padx= (5,5))
        #pywinstyles.set_opacity(self.lbl_gender, color="black")
        self.rad_male = customtkinter.CTkRadioButton(self, text='Male', variable=self.gender, value='Male',text_color='white',font=('',12),bg_color='black')
        self.rad_male.grid(row=16, column=0, sticky=W,padx= (5,5))
        #pywinstyles.set_opacity(self.rad_male, color="black")
        self.rad_female = customtkinter.CTkRadioButton(self, text='Female', variable=self.gender, value='Female',text_color='white',font=('',12),bg_color='black')
        ...
        # hight and
        self.lbl_height = customtkinter.CTkLabel(self, text='Height(ft):', font=("calibri", 19),bg_color='black',text_color='white')
        ...
        # weight
        self.lbl_weight = customtkinter.CTkLabel(self, text='Weight(ibs):', font=("calibri", 19),bg_color='black',text_color='white')
        ...
        # fitness a
        self.lbl_fitcert = customtkinter.CTkLabel(self, text='Physical fitness cert.:', font=("calibri", 19),bg_color='black',text_color='white')
        ...
        self.btn_cert_img = customtkinter.CTkButton(self, text='Browse...', command=self.ft_cert_upload,bg_color='black',fg_color='orange')
        ...
        # Additional space
        self.lbl_position = customtkinter.CTkLabel(self, text='', font=("calibri", 19),bg_color='black',text_color='white')
        ...
        self.btn_reset = customtkinter.CTkButton(self, text='CLEAR FORM', command=self.reset,bg_color='black',fg_color='orange',hover_color='dark orange')
        ...
        self.btn_back = customtkinter.CTkButton(self, image=icon, text='', command=self.back, bg_color='black',
                                                fg_color='orange', hover_color='dark orange', width=7)
    ...
    # def country(self):
    #     self.country = ['Select country','Abia State','Adamawa','Akwa Ibom','Anambra','Bauchi',]
    #     self.lbl= Lable(self, text= "Select your state",font=('', 12))
    #     self.lbl.grid(row= 14, column= 3, columnspan= 2, sticky =W)
    def reset(self):
        ...
        if len(valid_data) == 14:
            with sqlite3.connect('application.db') as con:
                ...
                table_query = '''CREATE TABLE IF NOT EXISTS
                               PLAYER (ID INTEGER primary key autoincrement,FirstName TEXT, LastName TEXT, DateOfBirth NUMERIC, Email INTEGER,Phone TEXT,Address TEXT,City BLOB,
                ...
                cursor.execute('''insert into PLAYER (FirstName,LastName,DateOfBirth,Email,Phone,Address,
    ...
    def error(self):
        CTkMessagebox(title='SUBMISSION FAILED', message='some necessary fields are yet to be filled!', icon='warning',
                      option_1='OK')
...
# window = Tk()
# window.title("PLAYER'S FORM")
# window.geometry("630x625")
# app = Player_app(window)
#
# app.mainloop()
# if "__name__" == "main":
#     sys.exit()
